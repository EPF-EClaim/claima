sap.ui.define([
	...
	return Controller.extend("claima.controller.App", {
		...
		onInit: async function () {
            ...
            ApprovalLog.onPARApproverDetermination(PARID);
		},
        ...
        onClaimsApproverDetermination: async function (claimID){
			...
			//create ZAPPROVER DETAILS can create but has an issue where cant create multiple with the same claim id? also must be in controller so cant use util js file
			// to do: pre approval side, JKEW checking and Alternative cost center checking
			console.log("this", this);
			var oModel = this.getView().getModel();
			var oBindList = oModel.bindList("/ZAPPROVER_DETAILS_CLAIMS");

			var oContext = oBindList.create({
				"CLAIM_ID": "CLM26000000215",
				"LEVEL": "2",
				"APPROVER_ID": "972211",
...
/* 				a.forEach((it) => {
		...
		_loadCurrentUser: function () {
			var that = this;
			var oUserModel = new sap.ui.model.json.JSONModel({ email: "904709smsm1@epf.gov.my.test.test" });
