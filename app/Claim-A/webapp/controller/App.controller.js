sap.ui.define([
	...
	return Controller.extend("claima.controller.App", {
		...
		onStartClaim_ClaimProcess: async function () {
			...
			var sClaimTypeCostCenter = await CustomValidator.costCenterDetermination(oInputModel.getProperty("/claimtype/type")).bind(this);
		...
		async onDefaultCostCenterDetermination(oEvent) {
			...
			var sDefaultCostCenter = await CustomValidator.costCenterDetermination(sClaimTypeId).bind(this);
