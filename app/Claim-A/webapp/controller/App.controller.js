		...
		*/
		...
		onSelect_ClaimHeader: async function () {
			...
			if (oClaimSubmissionModel.getProperty("/claim_header/housing_loan_scheme")) {
				oClaimSubmissionModel.setProperty("/claim_header/descr/housing_loan_scheme", await this._bindEclaimDescr("/ZHOUSING_LOAN_SCHEME", oClaimSubmissionModel.getProperty("/claim_header/housing_loan_scheme"), this._oConstant.PengangkutanFields.HOUSING_LOAN_SCHEME_ID, this._oConstant.PengangkutanFields.HOUSING_LOAN_SCHEME_DESC));
			}
			//lender name
			if (oClaimSubmissionModel.getProperty("/claim_header/lender_name")) {
				oClaimSubmissionModel.setProperty("/claim_header/descr/lender_name", await this._bindEclaimDescr("/ZLENDER_NAME", oClaimSubmissionModel.getProperty("/claim_header/lender_name"), this._oConstant.PengangkutanFields.LENDER_ID, this._oConstant.PengangkutanFields.LENDER_NAME));
			}
		}
