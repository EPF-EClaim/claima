sap.ui.define([
	...
	return Controller.extend("claima.controller.ClaimSubmission", {
		...
		_setClaimDetailSelectionMaster: function () {
			...
			//// Lodging Category
			this._setClaimDetailSelectionField("select_claimdetails_input_lodging_category", "ZLODGING_CAT", null, "LODGING_CATEGORY");
			//// Category/Purpose
		...
		onDownloadExcelReport: async function () {
			...
			try {
				...
				const aItemsColumnsMain = [
					...
					{ label: Utility.getText("label_claimdetails_input_claim_type_id"), property: "claim_type_id", type: "descr", width: 30 },
					{ label: Utility.getText("label_claimdetails_input_claim_type_item_id"), property: "claim_type_item_id", type: "descr", width: 30 },
				...
				const aClaimDetailColumns = [
					{ label: Utility.getText("label_claimdetails_input_anggota_name"), property: "anggota_name", field: "input_claimdetails_input_anggota_name", width: 30 },
					{ label: Utility.getText("label_claimdetails_input_dependent_name"), property: "dependent_name", field: "input_claimdetails_input_dependent_name", width: 30 },
					{ label: Utility.getText("label_claimdetails_input_type_of_professional_body"), property: "type_of_professional_body", field: "select_claimdetails_input_type_of_professional_body", type:"descr", width: 40 },
					{ label: Utility.getText("label_claimdetails_input_policy_number"), property: "policy_number", field: "input_claimdetails_input_policy_number", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_funeral_transportation"), property: "funeral_transportation", field: "select_claimdetails_input_funeral_transportation", type:"descr", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_actual_amount"), property: "actual_amount", field: "input_claimdetails_input_actual_amount", type: "number", scale: 2, width: 14 },
					{ label: Utility.getText("label_claimdetails_input_subsidised_amount"), property: "subsidised_amount", field: "input_claimdetails_input_subsidised_amount", type: "number", scale: 2, width: 14 },
					{ label: Utility.getText("label_claimdetails_input_request_approval_amount"), property: "request_approval_amount", field: "input_claimdetails_input_request_approval_amount", type: "number", scale: 2, width: 14 },
					...
					{ label: Utility.getText("label_claimdetails_input_percentage_compensation"), property: "percentage_compensation", field: "input_claimdetails_input_percentage_compensation", type: "number", scale: 2, width: 10 },
					{ label: Utility.getText("label_claimdetails_input_course_title"), property: "course_title", field: "input_claimdetails_input_course_title", width: 30 },
					{ label: Utility.getText("label_claimdetails_input_study_levels_id"), property: "study_levels_id", field: "select_claimdetails_input_study_levels_id", type:"descr", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_receipt_number"), property: "receipt_number", field: "input_claimdetails_input_receipt_number", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_receipt_date"), property: "receipt_date", field: "datepicker_claimdetails_input_receipt_date", type:"date", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_purpose"), property: "purpose", field: "input_claimdetails_input_purpose", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_start_date"), property: "start_date", field: "datepicker_claimdetails_input_start_date", type:"date", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_start_time"), property: "start_time", field: "timepicker_claimdetails_input_start_time", type:"time", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_end_date"), property: "end_date", field: "datepicker_claimdetails_input_end_date", type:"date", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_end_time"), property: "end_time", field: "timepicker_claimdetails_input_end_time", type:"time", width: 18 },
					...
					{ label: Utility.getText("label_claimdetails_input_no_of_days"), property: "no_of_days", field: "input_claimdetails_input_no_of_days", type:"number", scale: 0, width: 10 },
					{ label: Utility.getText("label_claimdetails_input_vehicle_type"), property: "vehicle_type", field: "select_claimdetails_input_vehicle_type", type:"descr", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_vehicle_ownership_id"), property: "vehicle_ownership_id", field: "select_claimdetails_input_vehicle_ownership_id", type:"descr", width: 18 },
					...
					{ label: Utility.getText("label_claimdetails_input_rate_per_km"), property: "rate_per_km", field: "input_claimdetails_input_rate_per_km", width: 14 },
					{ label: Utility.getText("label_claimdetails_input_fare_type_id"), property: "fare_type_id", field: "select_claimdetails_input_fare_type_id", type:"descr", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_vehicle_class_id"), property: "vehicle_class_id", field: "select_claimdetails_input_vehicle_class_id", type:"descr", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_flight_class"), property: "flight_class", field: "select_claimdetails_input_flight_class", type:"descr", width: 18 },
					...
					{ label: Utility.getText("label_claimdetails_input_location_type"), property: "location_type", field: "select_claimdetails_input_location_type", type:"descr", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_from_state_id"), property: "from_state_id", field: "input_claimdetails_input_from_state_id", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_from_location"), property: "from_location", field: "input_claimdetails_input_from_location", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_to_state_id"), property: "to_state_id", field: "input_claimdetails_input_to_state_id", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_to_location"), property: "to_location", field: "input_claimdetails_input_to_location", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_room_type"), property: "room_type", field: "select_claimdetails_input_room_type", type:"descr", width: 18 },
					...
					{ label: Utility.getText("label_claimdetails_input_need_foreign_currency"), property: "need_foreign_currency", field: "checkbox_claimdetails_input_need_foreign_currency", width: 10 },
					{ label: Utility.getText("label_claimdetails_input_currency_code"), property: "currency_code", field: "select_claimdetails_input_currency_code", width: 10 },
					{ label: Utility.getText("label_claimdetails_input_currency_rate"), property: "currency_rate", field: "input_claimdetails_input_currency_rate", type:"number", scale: 2, width: 10 },
					{ label: Utility.getText("label_claimdetails_input_currency_amount"), property: "currency_amount", field: "input_claimdetails_input_currency_amount", type:"number", scale: 2, width: 14 },
					{ label: Utility.getText("label_claimdetails_input_trip_start_date"), property: "trip_start_date", field: "datepicker_claimdetails_input_trip_start_date", type:"date", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_trip_start_time"), property: "trip_start_time", field: "timepicker_claimdetails_input_trip_start_time", type:"time", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_departure_time"), property: "departure_time", field: "timepicker_claimdetails_input_departure_time", type:"time", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_trip_end_date"), property: "trip_end_date", field: "datepicker_claimdetails_input_trip_end_date", type:"date", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_trip_end_time"), property: "trip_end_time", field: "timepicker_claimdetails_input_trip_end_time", type:"time", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_arrival_time"), property: "arrival_time", field: "timepicker_claimdetails_input_arrival_time", type:"time", width: 18 },
					...
					{ label: Utility.getText("label_claimdetails_input_no_of_family_member"), property: "no_of_family_member", field: "input_claimdetails_input_no_of_family_member", type:"number", scale: 2, width: 10 },
					{ label: Utility.getText("label_claimdetails_input_claim_category"), property: "claim_category", field: "select_claimdetails_input_claim_category", type:"descr", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_bill_no"), property: "bill_no", field: "input_claimdetails_input_bill_no", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_account_no"), property: "account_no", field: "input_claimdetails_input_account_no", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_bill_date"), property: "bill_date", field: "datepicker_claimdetails_input_bill_date", type:"date", width: 18 },
					{ label: Utility.getText("label_claimdetails_input_phone_no"), property: "phone_no", field: "input_claimdetails_input_phone_no", width: 18 },
					...
					{ label: Utility.getText("label_claimdetails_input_remark"), property: "remark", field: "input_claimdetails_input_remark", width: 30 },
