    ...
    async _loadClaimById(sClaimId) {
      ...
      const oHeaderBinding = oModel.bindList(
        ...
        aFilters,
        {
          $$ownRequest: true,
          $count: true,
          // $select: ["CLAIM_ID", "REQUEST_ID", "PURPOSE", "TRIP_START_DATE", "TRIP_END_DATE", "EVENT_START_DATE", "EVENT_END_DATE", "COMMENT", "LOCATION", "COST_CENTER", "ALTERNATE_COST_CENTER", "STATUS_ID", "STATUS_DESC", "TOTAL_CLAIM_AMOUNT", "PREAPPROVED_AMOUNT", "CASH_ADVANCE_AMOUNT", "FINAL_AMOUNT_TO_RECEIVE"]
          $select: ["*"]
        }
      );
