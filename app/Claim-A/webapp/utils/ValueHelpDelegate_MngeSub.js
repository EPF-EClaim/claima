    ...
    JSONValueHelpDelegate.retrieveContent = function(oValueHelp, oContainer, sContentId) {
        ...
        return new Promise((fnResolve, fnReject) => {
            ...
            sap.ui.require([
                ...
                const aColumns = oPayload.columns || ["ID", "Name", "Email"]; // Safe fallback
                ...
                const oTable = new Table(oContainer.getId() + "-Table", {
                    ...
                    columns: [
                        ...
                        new Column({ width: "10rem", header: new Label({text: aColumns[2] || "Email"}) }) // Added 3rd column
                    ]
                });
