...
entity ZEMP_CLAIM_REPORT_DETAILS
  as projection on ECLAIM.ZCLAIM_HEADER {
    key CLAIM_ID,
        ...
        ZCLAIM_ITEM.FROM_ELC,
        ZCLAIM_ITEM.TO_ELC,
        ZCLAIM_ITEM.FROM_LOCATION,
        ZCLAIM_ITEM.FROM_LOCATION_OFFICE,
        ZCLAIM_ITEM.ZOFFICE_LOCATION.LOCATION_DESC as FROM_LOCATION_DESC,
        ZCLAIM_ITEM.KM,
        ...
        ZCLAIM_ITEM.MORE_THAN_14_WORK_DAYS,
        ZCLAIM_ITEM.AREA,
...
entity ZEMP_REQUEST_REPORT_SUMMARY
  as projection on ECLAIM.ZREQUEST_HEADER {
    key REQUEST_ID, 
        ...
        ZREQUEST_ITEM.ZCLAIM_TYPE_ITEM.GL_ACCOUNT,
        ...
        REQUEST_DATE as SUBMITTED_DATE
  };
