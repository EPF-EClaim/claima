...
entity ZEMP_CLAIM_SUBMISSION
  as projection on ECLAIM.ZCLAIM_HEADER {
    ...
    key ZCLAIM_ITEM.CLAIM_SUB_ID,
        ...
        ZCLAIM_TYPE.CLAIM_TYPE_DESC,
        REJECT_REASON_ID,
        ZREJECT_REASON.REASON_DESC as REJECT_REASON_DESC,
        SEND_BACK_REASON_ID,
        ZSENDBACK_REASON.REASON_DESC as SENDBACK_REASON_DESC,
        SUBMITTED_DATE,
        APPROVER1,
        APPROVER2,
        APPROVER3,
        ...
        ZCLAIM_ITEM.START_DATE,
        ZCLAIM_ITEM.END_DATE,
        ZCLAIM_ITEM.LOCATION as ITEM_LOCATION,
        ZCLAIM_ITEM.AMOUNT,
